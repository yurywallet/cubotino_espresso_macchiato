...
This repo is not kept in sync with the upstream project; it carries local changes only (servo jog controls for tuning, HiDPI display fixes, and a per-face accept/reject webcam scanning flow).
